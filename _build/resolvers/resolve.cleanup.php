    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            ...
            if ($oldPackage && $oldPackage->compareVersion('1.1.0', '>')) {
                ...
                $cleanup = [
                    'core' => [
                        'components/crosscontextssettings/docs/changelog.txt',
                        'components/crosscontextssettings/docs/license.txt',
                        'components/crosscontextssettings/docs/readme.txt',
                        'components/crosscontextssettings/model/crosscontextssettings.class.php',
                    ],
                    'assets' => [
                        'components/crosscontextssettings/conn',
                        'components/crosscontextssettings/css/mgr.css',
                        'components/crosscontextssettings/js/mgr/sections',
                        'components/crosscontextssettings/js/mgr/widgets',
